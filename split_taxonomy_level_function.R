...
split_taxonomy_level <- function(taxonomy_table,taxonomy_level) {
  ...
  if (taxonomy_level==1){
    out_name="Kingdom"
  } else if (taxonomy_level==2){
    out_name="Phyla"
  } else if (taxonomy_level==3){
    out_name="Class"
  } else if (taxonomy_level==4){
    out_name="Order"
  } else if (taxonomy_level==5){
    out_name="Family"
  } else if (taxonomy_level==6){
    out_name="Genus"
  } else if (taxonomy_level==7){
    out_name="Species"
  } else if (taxonomy_level==8){
    out_name="Strain"
  }
  ...
  write.table(t_level_table, file=paste(out_name, "_table.txt", sep=""), quote = F, sep = "\t")
}
